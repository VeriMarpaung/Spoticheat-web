...
app.config['SESSION_REDIS'] = 'redis://default:PvhBBpsuCMXpPtapzuOnhlHAsqtHEJGm@redis.railway.internal:6379'  # Pastikan variabel lingkungan REDIS_URL diatur di Railway
